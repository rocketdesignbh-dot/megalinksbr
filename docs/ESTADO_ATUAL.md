...
- **Segue SEM teste:** redirect `/r/` real e preview de link do WhatsApp (só o 404 foi visto); comportamento com reduced-motion ligado; trial encerrado real; as 4 páginas puladas acima.
